...
public:
  ...
  enum State {
    ...
    State_Select,       ///< @see librepcb#project#SES_Select
    State_DrawWire,     ///< @see librepcb#project#SES_DrawWire
    State_AddNetLabel,  ///< @see librepcb#project#SES_AddNetLabel
    State_AddComponent  ///< @see librepcb#project#SES_AddComponent
  };
