...
public:
  ...
  enum EventType_t {
    ...
    GraphicsViewEvent,  ///< event from librepcb#GraphicsView @see
                        ///< librepcb#project#SEE_RedirectedQEvent
    // Special Events (with some additional parameters)
    StartAddComponent,      ///< @see librepcb#project#SEE_StartAddComponent
    SwitchToSchematicPage,  ///< @see librepcb#project#SEE_SwitchToSchematicPage
  };
 ...
 *
 * @see librepcb#project#SES_AddComponent
 */
 ...
 *
 * @see librepcb#project#SchematicEditor#setActiveSchematicIndex()
 */
